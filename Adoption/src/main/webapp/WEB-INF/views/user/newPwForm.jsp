	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
				<form class="login100-form validate-form flex-sb flex-w" action="newpw" method="post">
					...
					<div class="wrap-input100 validate-input m-b-12" data-validate = "Confirm Password is required">
						...
						<input class="input100" type="password" name="confirmpw" >
						<span class="focus-input100"></span>
					...
					<div class="container-login100-form-btn">
						...
						<input type="submit" class="login100-form-btn" value="Set Password">
					</div>
